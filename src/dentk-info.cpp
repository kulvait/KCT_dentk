...
int main(int argc, char* argv[])
{
    ...
    std::cout << io::xprintf("The file has dimensions (x,y,z)=(%d, %d, %d), each cell has x*y=%d pixels.\n\n", dimx, dimy, dimz, dimx * dimy);
...
int Args::parseArguments(int argc, char* argv[])
{
    ...
    app.add_option("input_den_file", input_file, "File in a DEN format to process.")->required()->check(CLI::ExistingFile);
